...
abstract class AbstractRequestArgumentResolver implements ArgumentValueResolverInterface
{
    ...
    protected DenormalizerInterface $denormalized;

    public function __construct(ValidatorInterface $validator, DenormalizerInterface $denormalized)
    {
    ...
    protected function validateDenormalizedRequest(object $denormalizedRequest): void
    {
        ...
        if ($denormalizedRequest instanceof ValidatorInterface) {
            $denormalizedRequest->validate($denormalizedRequest);
        }
    }
    ...
    {
        try {
            return $this->denormalized->denormalize($requestParams, $requestFqn, null, [
